      ...
      <section className="flex-1 flex flex-col justify-center px-3 md:px-8 lg:px-16 bg-surface-container-lowest">
        <div className="max-w-md w-full mx-auto py-1 md:py-4">
          ...
          <div className="grid grid-cols-2 gap-3 mb-2 md:mb-3">
            <button onClick={() => handleOAuth('google')} className="flex items-center justify-center gap-2 py-2.5 px-3 border border-outline-variant rounded-xl text-sm font-semibold text-on-surface-variant hover:bg-surface-container transition-colors font-body">
            ...
            <button onClick={() => handleOAuth('apple')} className="flex items-center justify-center gap-2 py-2.5 px-3 border border-outline-variant rounded-xl text-sm font-semibold text-on-surface-variant hover:bg-surface-container transition-colors font-body">
          ...
          <form onSubmit={handleSubmit} className="space-y-2.5 md:space-y-3">
            ...
            <div className="flex items-start gap-1.5 md:gap-2">
              ...
              <label htmlFor="terms" className="text-xs md:text-sm font-medium text-on-surface-variant leading-relaxed font-body">
                I agree to the <Link href="#" className="text-secondary font-bold hover:underline">Terms</Link> and <Link href="#" className="text-secondary font-bold hover:underline">Privacy Policy</Link>.
              </label>
            </div>
