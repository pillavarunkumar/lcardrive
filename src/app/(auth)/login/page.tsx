      ...
      <section className="w-full lg:w-1/2 flex flex-col items-center justify-center px-4 md:px-12 lg:px-24 bg-surface">
        <div className="w-full max-w-[400px]">
          ...
          <div className="grid grid-cols-2 gap-3 mb-3 md:mb-4">
            <button onClick={() => handleOAuth('google')} className="flex items-center justify-center gap-2 py-2.5 px-3 border border-outline-variant rounded-xl hover:bg-surface-container transition-all active:scale-95 text-sm font-semibold font-body">
            ...
            <button onClick={() => handleOAuth('apple')} className="flex items-center justify-center gap-2 py-2.5 px-3 border border-outline-variant rounded-xl hover:bg-surface-container transition-all active:scale-95 text-sm font-semibold font-body">
              <svg className="w-4 h-4 md:w-5 md:h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.78 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.88-3.12 1.87-2.38 5.98.68 7.13-.56 1.63-1.57 3.03-2.73 4.02zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
              </svg>
              Apple
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center">
                ...
                <Link href="#" className="text-[10px] md:text-xs font-medium text-secondary hover:text-on-secondary-container transition-colors font-body">Forgot password?</Link>
              </div>
              <div className="relative mt-1">
          ...
          <div className="hidden md:flex pt-8 text-center lg:text-left gap-x-6 justify-center lg:justify-start">
            ...
            <Link href="#" className="text-[10px] font-medium text-on-surface-variant/60 hover:text-secondary transition-colors font-body">Privacy Policy</Link>
            <Link href="#" className="text-[10px] font-medium text-on-surface-variant/60 hover:text-secondary transition-colors font-body">Terms of Service</Link>
          </div>
        </div>
      </section>
    </main>
