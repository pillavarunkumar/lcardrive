      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          ...
          <div className="md:col-span-8 space-y-8">
            {error && (
              <div className="p-4 bg-error-container/20 border border-error/20 rounded-xl text-sm text-error flex items-center gap-2">
            ...
            {loading ? (
              <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-gutter animate-pulse">
                <div className="h-6 bg-outline-variant/40 rounded w-1/3 mb-8" />
                <div className="space-y-4">
                  <div className="h-12 bg-outline-variant/40 rounded" />
                  <div className="h-12 bg-outline-variant/40 rounded" />
                  <div className="h-12 bg-outline-variant/40 rounded" />
                </div>
              </div>
              ...
              <>
                ...
                <section className="bg-surface-container-lowest border border-outline-variant rounded-xl p-gutter">
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      <h3 className="text-headline-md font-headline-md text-primary">Account Information</h3>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-label-sm font-label-sm text-secondary uppercase px-1">First Name</label>
                        <input
                          type="text"
                          value={firstName}
                      ...
                      <div className="space-y-2">
                        <label className="text-label-sm font-label-sm text-secondary uppercase px-1">Last Name</label>
                        <input
                          type="text"
                          value={lastName}
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between p-4 bg-surface rounded-xl border border-outline-variant/30">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-label-sm font-label-sm text-secondary">Last changed via Clerk</p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-surface rounded-xl border border-outline-variant/30">
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        <div className="w-12 h-6 bg-secondary-container peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-6 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary" />
                      </label>
                    </div>
                  </div>
                </section>
                ...
                <section className="bg-surface-container-lowest border border-outline-variant rounded-xl p-gutter">
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      <h3 className="text-headline-md font-headline-md text-primary">Notification Preferences</h3>
